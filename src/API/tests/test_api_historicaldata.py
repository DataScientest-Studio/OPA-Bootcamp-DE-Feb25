...
def test_Historicaldata_get_no_data(client):
    logger.info("GET .../opa/historicaldata")
    response = client.get('opa/historicaldata')
...
def test_Historicaldata_get_OK(client):
    ...
    response = client.post("opa/historicaldata", json=updated_at)
    response = client.get('opa/historicaldata')
...
def test_Historicaldata_post_no_data(client):
    logger.info("POST .../opa/historicaldata")
    response = client.post('opa/historicaldata')
